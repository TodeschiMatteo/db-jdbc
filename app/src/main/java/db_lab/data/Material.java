        ...
        public static Map<Material, Float> forProduct(Connection connection, int productId) {
            ...
            try (
                ...
                while (resultSet.next()) {
                    var materialCode = resultSet.getInt("code");
                    var materialName = resultSet.getString("description");
                    var materialPercentage = resultSet.getFloat("percent");
                    var material = new Material(materialCode, materialName);
                    materials.put(material, materialPercentage);
                  }
